...
export function Freon407Page({ onRequest }) {
  useEffect(() => {
    document.title = "Купить фреон R407C в Москве оптом и в розницу — РусХимСоюз";
  }, []);
  ...
  return (
    <main className="product-page" id="top">
        ...
        <div className="container">
          ...
          <div className="product-hero__grid">
            <div className="product-hero__content">
              ...
              <h1 className="product-hero__title">Купить фреон R407C в Москве оптом и в розницу</h1>
      ...
      <ProductPriceSection code="R407C" />
