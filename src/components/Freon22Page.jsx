...
export function Freon22Page({ onRequest }) {
  useEffect(() => {
    document.title = "Купить фреон R22 в Москве оптом и в розницу — РусХимСоюз";
  }, []);
        ...
        <div className="container">
          ...
          <div className="product-hero__grid">
            <div className="product-hero__content">
              ...
              <h1 className="product-hero__title">Купить фреон R22 в Москве оптом и в розницу</h1>
